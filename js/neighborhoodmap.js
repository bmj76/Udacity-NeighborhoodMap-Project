...
var ViewModel = function() {
	...
	self.selectListItem = function(place) {
		...
		ko.utils.arrayForEach(self.placeList(), function(item) {
			if (item != place) {
				//Hides the marker that does not matched the clicked item
				item.marker.setVisible(false);
			} else {
				/* 	Displays the marker that matches the clicked item
					Updates the currentFilter value which updates the input box via knockout
